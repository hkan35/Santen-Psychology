            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
					...
					<li class="dropdown">
						...
						<li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><strong>Reports</strong> <i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                <li class="active"><a <?=$this->Html->link('Home','/reports/index')?></a></li>
...
<div class="container">
    ...
    <td><?= $report->has('reporttype') ? $this->Html->link($report->reporttype->reportTypeName, ['controller' => 'Reporttypes', 'action' => 'view', $report->reporttype->id]) : '' ?></td>
	...
	['class' => 'btn btn-primary btn-xs glyphicon glyphicon-trash','confirm' => __('Are you sure you want to delete # {0}?', $report->id)]
)?>
	</td>
