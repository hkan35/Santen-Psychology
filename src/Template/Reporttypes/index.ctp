					...
					<li class="dropdown">
						...
						<li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
								...
								<li class="active"><a <?=$this->Html->link('Manage report types','/reporttypes/index')?></a></li>
...
<div class="container">
	...
	['class' => 'btn btn-primary btn-xs glyphicon glyphicon-trash','confirm' => __('Are you sure you want to delete # {0}?', $reporttype->id)]
)?>
	</td>
