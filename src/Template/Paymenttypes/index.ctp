					...
					<li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a <?=$this->Html->link('Add new invoice','/invoices/add')?></a></li>
                             	...
                             	<li  class="active"><a <?=$this->Html->link('Manage payment types','/paymenttypes/index')?></a></li>
...
<div class="container">
	...
	['class' => 'btn btn-primary btn-xs glyphicon glyphicon-trash','confirm' => __('Are you sure you want to delete # {0}?', $paymenttype->id)]
)?>
	</td>
