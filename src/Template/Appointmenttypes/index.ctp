                    ...
                    <ul class="nav navbar-nav">
						...
						<li class="dropdown" >
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a <?=$this->Html->link('Manage appointment types','/appointmenttypes/index')?></a></li>
...
<script src="http://getbootstrap.com/dist/js/bootstrap.min.js"></script>
	...
	<?= $this->Html->link(
    '',
    ['action' => 'view', $appointmenttype->id],
	['class' => 'btn btn-primary btn-xs glyphicon glyphicon-list-alt']
)?>
	
	<?= $this->Html->link(
    '',
    ['action' => 'edit', $appointmenttype->id],
	...
	['class' => 'btn btn-primary btn-xs glyphicon glyphicon-trash','confirm' => __('Are you sure you want to delete # {0}?', $appointmenttype->id)]
)?>
	</td>
