...
<body>
    ...
    <section id="blog" class="container">
        <div class="center">
			...
			<br>Yvonne Santen considers her approach to be eclectic meaning that when working with a client,
			<br>she draws techniques from a variety of therapeutic approaches to suit the needs of the client.
			<br>
